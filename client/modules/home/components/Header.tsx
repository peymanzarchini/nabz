...
import { Search, ChevronDown, Menu, X, ChevronLeft, Sun, Moon } from "lucide-react";
...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-background/70 backdrop-blur-xl border-b border-border/30 dark:border-white/30 transition-all duration-300 shadow-sm">
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-background/95 backdrop-blur-2xl border-t border-border/30 shadow-xl animate-slide-up overflow-hidden">
