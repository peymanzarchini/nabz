...
const LogoutBox = ({ logout, setIsLogoutOpen }: LogoutBoxProps) => {
  return (
    <div className="fixed inset-0 z-100 flex items-center justify-center p-4">
      ...
      />
      <div className="relative bg-card border border-border rounded-sm shadow-2xl w-full max-w-md p-6 animate-slide-up text-center">
        <h2 className="text-xl font-bold text-foreground mb-4">خروج از حساب</h2>
